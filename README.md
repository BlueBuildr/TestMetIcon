# HelloID-Conn-Prov-Target-TestMetIcon
...
- [HelloID-Conn-Prov-Target-TestMetIcon](#helloid-conn-prov-target-connectorname)
...
_HelloID-Conn-Prov-Target-TestMetIcon_ is a _target_ connector. _TestMetIcon_ provides a set of REST APIs that allow you to programmatically interact with its data.
...
```
https://raw.githubusercontent.com/Tools4everBV/HelloID-Conn-Prov-Target-TestMetIcon/refs/heads/main/Icon.png
```
...
The correlation configuration is used to specify which properties will be used to match an existing account within _TestMetIcon_ to a person in _HelloID_.
...
The account reference is populated with the property `id` property from _TestMetIcon_
